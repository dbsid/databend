...
fn test_statement() {
    ...
    let cases = &[
        ...
        r#"CREATE ORDERED INDEX IF NOT EXISTS idx_w ON t1 (wallet_address, platform_id, last_active_time DESC) INCLUDE (balance, tag_black_hole) WITH (COMPRESSION='ZSTD');"#,
