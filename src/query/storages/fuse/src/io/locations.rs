...
use databend_storages_common_index::ORDERED_INDEX_FILE_VERSION;
...
pub struct TableMetaLocationGenerator {
    ...
    ordered_index_location_prefix: String,
...
impl TableMetaLocationGenerator {
    pub fn new(prefix: String) -> Self {
        ...
        let ordered_index_location_prefix =
            format!("{}/{}/", &prefix, FUSE_TBL_ORDERED_INDEX_PREFIX);
    ...
    pub fn ordered_index_location_prefix(&self) -> &str {
        &self.ordered_index_location_prefix
    }

    pub fn gen_specific_ordered_index_prefix(
        &self,
        index_name: &str,
        index_version: &str,
    ) -> String {
    ...
    pub fn gen_ordered_index_location_from_block_location(
        loc: &str,
        index_name: &str,
        index_version: &str,
    ) -> String {
