...
pub enum ProfileStatisticsName {
    ...
    BtreeIndexCandidateCollectTime,
    BtreeIndexCandidateSortTime,
    BtreeIndexCandidateReadTime,
    BtreeIndexDataBlockLoadTime,
    BtreeIndexRowSelectTime,
    BtreeIndexOutputBuildTime,
    BtreeIndexPartsScanned,
...
pub fn get_statistics_desc() -> Arc<BTreeMap<ProfileStatisticsName, ProfileDesc>> {
    PROFILES_DESC.get_or_init(|| {
        Arc::new(BTreeMap::from([
            ...
            (ProfileStatisticsName::BtreeIndexCandidateCollectTime, ProfileDesc {
                display_name: "btree index candidate collect time",
                desc: "Time spent collecting BTREE index candidate data blocks from scan parts",
                index: ProfileStatisticsName::BtreeIndexCandidateCollectTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::BtreeIndexCandidateSortTime, ProfileDesc {
                display_name: "btree index candidate sort time",
                desc: "Time spent sorting BTREE index candidate data blocks",
                index: ProfileStatisticsName::BtreeIndexCandidateSortTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::BtreeIndexCandidateReadTime, ProfileDesc {
                display_name: "btree index candidate read time",
                desc: "Time spent reading, filtering, and top-k merging BTREE index candidate rows",
                index: ProfileStatisticsName::BtreeIndexCandidateReadTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::BtreeIndexDataBlockLoadTime, ProfileDesc {
                display_name: "btree index data block load time",
                desc: "Time spent loading BTREE index data blocks, including cache lookup",
                index: ProfileStatisticsName::BtreeIndexDataBlockLoadTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::BtreeIndexRowSelectTime, ProfileDesc {
                display_name: "btree index row select time",
                desc: "Time spent selecting rows from decoded BTREE index data blocks",
                index: ProfileStatisticsName::BtreeIndexRowSelectTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::BtreeIndexOutputBuildTime, ProfileDesc {
                display_name: "btree index output build time",
                desc: "Time spent building the output block from BTREE index payload rows",
                index: ProfileStatisticsName::BtreeIndexOutputBuildTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::BtreeIndexPartsScanned, ProfileDesc {
                display_name: "btree index parts scanned",
                desc: "The number of Fuse parts checked for BTREE index candidate blocks",
                index: ProfileStatisticsName::BtreeIndexPartsScanned as usize,
                unit: StatisticsUnit::Count,
                plain_statistics: true,
            }),
