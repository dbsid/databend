...
pub enum ProfileStatisticsName {
    ...
    OrderedIndexMetaLoadTime,
    OrderedIndexDataBlockReadTime,
    OrderedIndexDataBlockDecodeTime,
    OrderedIndexPayloadDecodeTime,
    OrderedIndexFilterTime,
    OrderedIndexCandidateCollectTime,
    OrderedIndexCandidateSortTime,
    OrderedIndexCandidateReadTime,
    OrderedIndexDataBlockLoadTime,
    OrderedIndexRowSelectTime,
    OrderedIndexOutputBuildTime,
    OrderedIndexPartsScanned,
    OrderedIndexCandidateBlocks,
    OrderedIndexRowsDecoded,
    OrderedIndexRowsMatched,
}
...
pub fn get_statistics_desc() -> Arc<BTreeMap<ProfileStatisticsName, ProfileDesc>> {
    PROFILES_DESC.get_or_init(|| {
        Arc::new(BTreeMap::from([
            ...
            (ProfileStatisticsName::OrderedIndexMetaLoadTime, ProfileDesc {
                display_name: "ordered index meta load time",
                desc: "Time spent loading ORDERED index footer, filter block, and index block",
                index: ProfileStatisticsName::OrderedIndexMetaLoadTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexDataBlockReadTime, ProfileDesc {
                display_name: "ordered index data block read time",
                desc: "Time spent reading ORDERED index data blocks",
                index: ProfileStatisticsName::OrderedIndexDataBlockReadTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexDataBlockDecodeTime, ProfileDesc {
                display_name: "ordered index data block decode time",
                desc: "Time spent decoding ORDERED index data blocks",
                index: ProfileStatisticsName::OrderedIndexDataBlockDecodeTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexPayloadDecodeTime, ProfileDesc {
                display_name: "ordered index payload decode time",
                desc: "Time spent decoding ORDERED index row payloads",
                index: ProfileStatisticsName::OrderedIndexPayloadDecodeTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexFilterTime, ProfileDesc {
                display_name: "ordered index filter time",
                desc: "Time spent applying filters to ORDERED index payload rows",
                index: ProfileStatisticsName::OrderedIndexFilterTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexCandidateCollectTime, ProfileDesc {
                display_name: "ordered index candidate collect time",
                desc: "Time spent collecting ORDERED index candidate data blocks from scan parts",
                index: ProfileStatisticsName::OrderedIndexCandidateCollectTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexCandidateSortTime, ProfileDesc {
                display_name: "ordered index candidate sort time",
                desc: "Time spent sorting ORDERED index candidate data blocks",
                index: ProfileStatisticsName::OrderedIndexCandidateSortTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexCandidateReadTime, ProfileDesc {
                display_name: "ordered index candidate read time",
                desc: "Time spent reading, filtering, and top-k merging ORDERED index candidate rows",
                index: ProfileStatisticsName::OrderedIndexCandidateReadTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexDataBlockLoadTime, ProfileDesc {
                display_name: "ordered index data block load time",
                desc: "Time spent loading ORDERED index data blocks, including cache lookup",
                index: ProfileStatisticsName::OrderedIndexDataBlockLoadTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexRowSelectTime, ProfileDesc {
                display_name: "ordered index row select time",
                desc: "Time spent selecting rows from decoded ORDERED index data blocks",
                index: ProfileStatisticsName::OrderedIndexRowSelectTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexOutputBuildTime, ProfileDesc {
                display_name: "ordered index output build time",
                desc: "Time spent building the output block from ORDERED index payload rows",
                index: ProfileStatisticsName::OrderedIndexOutputBuildTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::OrderedIndexPartsScanned, ProfileDesc {
                display_name: "ordered index parts scanned",
                desc: "The number of Fuse parts checked for ORDERED index candidate blocks",
                index: ProfileStatisticsName::OrderedIndexPartsScanned as usize,
                unit: StatisticsUnit::Count,
                plain_statistics: true,
            }),
            (ProfileStatisticsName::OrderedIndexCandidateBlocks, ProfileDesc {
                display_name: "ordered index candidate blocks",
                desc: "The number of candidate ORDERED index data blocks selected by prefix pruning",
                index: ProfileStatisticsName::OrderedIndexCandidateBlocks as usize,
                unit: StatisticsUnit::Count,
                plain_statistics: true,
            }),
            (ProfileStatisticsName::OrderedIndexRowsDecoded, ProfileDesc {
                display_name: "ordered index rows decoded",
                desc: "The number of ORDERED index rows decoded from data blocks",
                index: ProfileStatisticsName::OrderedIndexRowsDecoded as usize,
                unit: StatisticsUnit::Rows,
                plain_statistics: true,
            }),
            (ProfileStatisticsName::OrderedIndexRowsMatched, ProfileDesc {
                display_name: "ordered index rows matched",
                desc: "The number of ORDERED index rows kept after prefix and payload filters",
                index: ProfileStatisticsName::OrderedIndexRowsMatched as usize,
                unit: StatisticsUnit::Rows,
                plain_statistics: true,
            }),
        ]))
